...
@Component({
  selector: 'app-fvaccination',
  templateUrl: './fvaccination.component.html',
  styleUrls: ['./fvaccination.component.css']
})
export class FvaccinationComponent implements OnInit {
